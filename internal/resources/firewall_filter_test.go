...
func TestFirewallFilterResource_Schema(t *testing.T) {
	r := NewFirewallFilterResource()
...
func TestFirewallFilterResource_Configure(t *testing.T) {
	r := &FirewallFilterResource{}
